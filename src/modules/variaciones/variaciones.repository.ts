...
const create = async (data: any) => {
  ...
  const [result] = await pool.query(
    `INSERT INTO variaciones (producto_id, variacion, precio, precioPromocional, esPromocion, enEcommerce, imagen, estado)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
    [producto_id, variacion, precio, precioPromocional, esPromocion, enEcommerce, imagen, estado]
  );
