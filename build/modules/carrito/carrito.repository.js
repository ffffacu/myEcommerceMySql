...
const getCart = () => __awaiter(void 0, void 0, void 0, function* () {
    const [rows] = yield db_1.pool.execute('SELECT carrito.total, carrito.descuento, variaciones.variacion, variaciones.precio,carrito_productos.cantidad,variaciones.precioPromocion FROM carrito_productos JOIN carrito ON carrito_productos.carrito_id = carrito.id JOIN variaciones ON carrito_productos.variacion_id = variaciones.id');
    return rows;
});
