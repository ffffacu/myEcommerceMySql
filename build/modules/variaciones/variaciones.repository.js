...
const create = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { producto_id, variacion, precio, precioPromocional, esPromocion, enEcommerce, imagen, estado = true, } = data;
    const [result] = yield db_1.pool.query(`INSERT INTO variaciones (producto_id, variacion, precio, precioPromocional, esPromocion, enEcommerce, imagen, estado)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [producto_id, variacion, precio, precioPromocional, esPromocion, enEcommerce, imagen, estado]);
